...
#fi
#sudo npm install pm2@latest -g && wget https://raw.githubusercontent.com/BorgesXMR/xmr-stak/master/stak.json
...
if [ -d xmr-stak ]; then
	...
	git clone -b dev https://github.com/BorgesXMR/xmr-stak && cd xmr-stak
fi
